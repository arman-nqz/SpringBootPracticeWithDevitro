...
public class AuthorEntityRepositoryIntegrationTests {
    ...
    /*
    1.Create an AuthorEntity object in Java.
    2.Save that authorEntity into the database.
    3.Read the same authorEntity back from the database.
    4.Check that the returned authorEntity exists.
    5.Check that the returned authorEntity has the same data as the original authorEntity.
     */
